  ...
  console: [
    {
      ...
      imageUrl: '/images/console1.jpg',
    },
    {
      id: 15,
      name: 'コンソールサイドパット',
      description: '快適な乗車感を実現するサイドパッド',
      imageUrl: '/images/console2.jpg',
    },
    {
      id: 16,
      name: 'ニーパット',
      description: '長時間のドライブでも快適な姿勢をサポート',
      imageUrl: '/images/console3.jpg',
    },
  ],
  door: [
    {
    ...
    },
    {
      ...
      imageUrl: '/images/door3.jpg',
    },
    {
      id: 20,
      name: 'ドアオーナメント',
      description: '高品質な素材を使用した耐久性のあるオーナメント',
      imageUrl: '/images/door4.jpg',
    },
  ],
  pillar: [
    {
      ...
      imageUrl: '/images/pillar1.jpg',
    },
    {
      id: 22,
      name: 'センターピラー',
      description: '車体強度を保ちながら美しい内装を実現',
      imageUrl: '/images/pillar2.jpg',
    },
    {
      id: 23,
      name: 'ルーフサイドピラー',
      description: '空力性能と美観を両立した革新的なデザイン',
      imageUrl: '/images/pillar3.jpg',
    },
  ]
};
          ...
          >
            <div className="h-64 bg-gray-100 flex items-center justify-center">
              ...
              <div className="w-full h-full flex items-center justify-center">
                <p className="text-gray-400">画像スペース</p>
              </div>
            </div>
            <div className="p-5">
      ...
      <div className="w-full mt-16 bg-gray-50 py-8">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">製品に関するお問い合わせ</h2>
