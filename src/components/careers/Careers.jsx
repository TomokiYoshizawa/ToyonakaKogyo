    ...
    <div className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300">
      ...
      <div className="bg-gray-50 p-6">
        <button
          ...
          className="w-full bg-primary text-white py-4 px-6 rounded-lg hover:bg-secondary transition-colors duration-300 flex items-center justify-center space-x-2 font-medium text-lg"
        >
          <span>この職種に応募する</span>
