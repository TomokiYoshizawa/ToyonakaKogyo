...
const productCategories = [
  {
    id: 'seats',
    name: 'シート',
    image: '/images/product-seats.jpg',
    subcategories: ['自動車用シート', '航空機シート']
  },
  {
    id: 'interior',
    name: '内外装',
    image: '/images/product-interior.jpg',
    subcategories: ['ドアトリム', '天井まわり']
  },
  {
    id: 'units',
    name: 'ユニット部品',
    image: '/images/product-units.jpg',
  ...
  },
  {
    id: 'other',
    name: 'その他',
    image: '/images/product-other.jpg',
            ...
            <div className="lg:col-span-3 flex items-center">
              <div className="bg-gray-100 rounded-lg p-3 w-full">
                <div className="aspect-w-16 aspect-h-9 bg-gray-200 rounded-lg flex items-center justify-center">
                  <p className="text-gray-400">車両イラスト</p>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-9">
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-5">
                {productCategories.map((category) => (
                  <div key={category.id} className="bg-white border border-gray-200 rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-shadow duration-300">
                    ...
                    <div className="p-4">
                      ...
                      <div className="mt-3 text-right">
                        <Link to={`/products?category=${category.id}`} className="inline-flex items-center text-primary hover:text-secondary text-base font-medium">
                          <span>詳細</span>
